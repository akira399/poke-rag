...
| 首页 · 免配置直接提问 | 伤害问答 · 默认《宝可梦冠军》口径 |
|---|---|
| ![](docs/screenshots/01-home.png) | ![](docs/screenshots/02-damage.png) |
| **极端情况分析** · 三种培养配置下的判定 | **《宝可梦冠军》问答** · 引用可展开跳转来源 |
| ![](docs/screenshots/03-extreme.png) | ![](docs/screenshots/04-champions.png) |
...
- 伤害问答：直接问「快龙用龙爪打喷火龙多少血」——规则引擎按对局环境计算，
  默认《宝可梦冠军》口径（50 级、66 点点数制、冠军招式与道具改动），提到
  朱紫 / Gen9 等则按主线口径（与 @smogon/calc 对拍 86/86 一致）；输出伤害范围、
  一击击杀概率与极端情况分析
